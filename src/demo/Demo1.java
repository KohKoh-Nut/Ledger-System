...
public class Demo1 {
    static void main(String[] args) {
        ...
        try {
            ...
            f1.addIncome(Amount.of(500, Amount.Currency.SGD), Date.of(1, 1, 2026), Category.of("Allowance"), "From " +
                    "Dad");
            ...
            f1.addTransfer(Amount.of(500, Amount.Currency.SGD), Date.of(6, 1, 2026), savings, f2, "Emergency Fund " +
                    "Transfer");
            ...
            f1.addTransfer(Amount.of(100, Amount.Currency.SGD), Date.of(2, 3, 2026), transport, f5, "Withdraw cash " +
                    "for JB");
            ...
            f5.addExpense(Amount.of(120.0, Amount.Currency.MYR), Date.of(4, 3, 2026), shopping, "Cheap books at " +
                    "Borders");
            ...
            f1.addTransfer(Amount.of(600, Amount.Currency.SGD), Date.of(18, 3, 2026), savings, f2, "Quarterly Bonus " +
                    "Savings");
            ...
            f1.addIncome(Amount.of(500, Amount.Currency.SGD), Date.of(1, 4, 2026), Category.of("Allowance"), "Dad " +
                    "April");
            ...
            f1.addExpense(Amount.of(8.00, Amount.Currency.SGD), Date.current(), Category.of("Sport"), "Badminton " +
                    "court");
